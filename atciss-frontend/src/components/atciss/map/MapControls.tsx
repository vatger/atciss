  ...
  return (
    <Search map={map}>
      ...
      >
        ...
        <Button
          variant={areas_dfs ? "selectedSecondaryNav" : "secondaryNav"}
          sx={{ flex: 1, visibility: areas ? "visible" : "hidden" }}
          onClick={() => dispatch(setAreasDFS(!areas_dfs))}
        >
          DFS
        </Button>
        <Button
          variant={areas_vlara ? "selectedSecondaryNav" : "secondaryNav"}
          sx={{ flex: 1, visibility: areas ? "visible" : "hidden" }}
          onClick={() => dispatch(setAreasVLARA(!areas_vlara))}
        >
          VATSIM
        </Button>
      </Flex>
