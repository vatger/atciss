...
const icons: { [key: string]: string } = {
  ...
  vortac: `
  <g><path d="M32,34.5c-3.1,0-5.6-2.5-5.6-5.6c0-3.1,2.5-5.6,5.6-5.6c3.1,0,5.6,2.5,5.6,5.6C37.6,32,35.1,34.5,32,34.5z"/><path fill="#FFFFFF" d="M32,24.8c2.3,0,4.1,1.8,4.1,4.1S34.3,33,32,33s-4.1-1.8-4.1-4.1S29.7,24.8,32,24.8 M32,21.8 c-3.9,0-7.1,3.2-7.1,7.1S28.1,36,32,36s7.1-3.2,7.1-7.1S35.9,21.8,32,21.8L32,21.8z"/></g>
  <g>
  <path d="M23.8,59.2c-2,0-3.6-1.6-3.6-3.6V44.2l-7.3-12.8l-9.5-5.7c-1.6-1-2.2-3.1-1.3-4.8l8.2-14.4c0.7-1.1,1.8-1.8,3.1-1.8
  ...
  <path fill="#FFFFFF" d="M50.5,6.3c0.7,0,1.4,0.4,1.8,1l8.2,14.4c0.6,1,0.2,2.2-0.7,2.8L50,30.4l-7.7,13.4v11.8
    ...
    C54,4.3,52.3,3.3,50.5,3.3L50.5,3.3z M24.3,19.6h15.3l4.1,7.3l-7.7,13.5h-8.2l-7.7-13.5L24.3,19.6L24.3,19.6z"/></g>`,
  tacan: `
  <g><path d="M32,33.5c-3.1,0-5.6-2.5-5.6-5.6c0-3.1,2.5-5.6,5.6-5.6c3.1,0,5.6,2.5,5.6,5.6C37.6,31,35.1,33.5,32,33.5z"/><path fill="#FFFFFF" d="M32,23.8c2.3,0,4.1,1.8,4.1,4.1S34.3,32,32,32c-2.3,0-4.1-1.8-4.1-4.1S29.7,23.8,32,23.8 M32,20.8 c-3.9,0-7.1,3.2-7.1,7.1S28.1,35,32,35s7.1-3.2,7.1-7.1S35.9,20.8,32,20.8L32,20.8z"/></g>
  <g>
  <path d="M23.8,58c-2,0-3.5-1.6-3.5-3.5V43.1l-7.2-12.7l-9.4-5.6c-1.6-1-2.2-3.1-1.3-4.8l8.2-14.3C11.2,4.7,12.4,4,13.7,4
  ...
  <path fill="#FFFFFF" d="M13.7,5.5c0.3,0,0.7,0.1,1,0.3c0,0,0,0,0,0l9.7,5.8h15.2l9.7-5.8c0.3-0.2,0.7-0.3,1-0.3
